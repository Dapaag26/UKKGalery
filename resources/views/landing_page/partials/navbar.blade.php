        ...
        <div class="container">
            <div class="header-wrap">
                <div class="logo logo-width-1">
                    <a href="index.html"><img src="{{ asset('evara/assets/imgs/theme/G.png') }}" alt="logo"></a>
                </div>
            ...
            <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                        <nav>
                            <ul>
                                ...
                                <li><a href="shop-grid-right.html">Categories</a>

                                </li>
                                <li class="position-static"><a href="#">Menu</a>
                ...
                <div class="hotline d-none d-lg-block">
                    ...
                    @if (auth()->check())
                        ...
                        <p><a href="{{ route('dashboard.index') }}">Kembali</a></p>
                    @else
                        <!-- Jika user belum login -->
                        <p>
                            <i class="fi-rs-user"></i>
                            <a href="{{ route('login.login') }}">Login </a> / <a href="/register">Register</a>
                        </p>
                    @endif
                </div>
